...
namespace terminality
{
	...
	public:
		...
		void RenderLine(const Point& point, const int32_t length, Color fg, Color bg, short direction = 0);
		void RenderLine(const Point& point, const int32_t length, VectorStyle style, short direction = 0);
		void RenderLine(const Point& point, const int32_t length, VectorStyle style, Color fg, Color bg, short direction = 0);
		void RenderLine(const Point& fromPoint, const Point& toPoint);
		void RenderLine(const Point& fromPoint, const Point& toPoint, Color fg, Color bg);
		void RenderLine(const Point& fromPoint, const Point& toPoint, VectorStyle style);
		void RenderLine(const Point& fromPoint, const Point& toPoint, VectorStyle style, Color fg, Color bg);
		void RenderLine(const Vector& vector);
		void RenderLine(const Vector& vector, Color fg, Color bg);
		void RenderLine(const Vector& vector, VectorStyle style);
		void RenderLine(const Vector& vector, VectorStyle style, Color fg, Color bg);
	};
}
